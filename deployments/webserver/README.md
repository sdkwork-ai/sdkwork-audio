...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `audio-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `audio-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `audio-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `audio.sdkwork.com` | 443 ssl + 80 |
