...
Module `sdkwork-audio` · runtime code `audio` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `audio-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `audio-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `audio-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `audio-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `audio.sdkwork.com` | 443 ssl + 80 |
