# sdkwork-audio Source Configuration
...
| `appId` | `sdkwork-audio` |
| `runtimeCode` | `audio` |
| Config root | `/etc/sdkwork/audio/` |
| Runtime TOML | `/etc/sdkwork/audio/config.toml` |
| Secrets | `/etc/sdkwork/audio/secrets/` |
| Override | `SDKWORK_AUDIO_CONFIG_FILE` |
