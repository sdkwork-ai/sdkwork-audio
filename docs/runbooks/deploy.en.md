# Runbook — sdkwork-audio deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-audio-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-audio/bundle`, loads the image, starts
